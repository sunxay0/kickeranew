...
import { XMarkIcon, InfoIcon, ShieldCheckIcon, LifebuoyIcon, EmailIcon, TikTokIcon, InstagramIcon, VKIcon, TelegramIcon } from './icons';
...
export const SettingsPanel: React.FC<SettingsPanelProps> = ({ onClose }) => {
  ...
  const contacts = [
    { label: 'Email', href: 'mailto:kickora@gmail.com', icon: <EmailIcon /> },
    { label: 'TikTok', href: 'https://tiktok.com/@kickora', icon: <TikTokIcon /> },
    { label: 'Instagram', href: 'https://instagram.com/@kickora', icon: <InstagramIcon /> },
    { label: 'VKontakte', href: 'https://vk.com/kickora', icon: <VKIcon /> },
    { label: 'Telegram', href: 'https://t.me/kickora', icon: <TelegramIcon /> },
  ];
